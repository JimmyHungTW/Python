...
for file in files:
    ...
    if Data_Category==['Margining result for DQ\n']:
        ...
        DQ_result1.write(file +','+ Data_Category +','+ Positive_value +','+ Positive_spec +','+ Negative_value +','+ Negative_spec)
        DQ_result1.write('\n')
        ...
        #final_data1=(file, Data_Category, Positive_value, Positive_spec , Negative_value, Negative_spec)
        #final_data=str(final_data1)
        CPU_result1=open(original_path + '.\A_CA_result_'+runtime+'.csv','a+')
        CPU_result1.write(file +','+ Data_Category +','+ Positive_value +','+ Positive_spec +','+ Negative_value +','+ Negative_spec)
        CPU_result1.write('\n')
    else:
        ...
        #final_data1=(file, Data_Category, Positive_value, Positive_spec , Negative_value, Negative_spec)
        #final_data=str(final_data1)
        CA_result1=open(original_path + '.\A_CPU_result_' + runtime + '.csv','a+')
        CA_result1.write(file +','+ Data_Category +','+ Positive_value +','+ Positive_spec +','+ Negative_value +','+ Negative_spec)
        CA_result1.write('\n')
