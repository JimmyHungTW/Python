...
for file in files:
    ...
    if writing_counter==0:
        Write_result.write('File name'+ ',' +'Eye center width (units)'+ ',' +'Eye center width (UI)'+ ',' +'Eye center heigh (units)'+ ',' +'Eye opening are (units'+ ',' +'Eye max width (units)'+ ',' +'Eye max width (UI)'+ ',' +'Eye max height (units)')
        Write_result.write('\n')
        writing_counter = writing_counter + 1
    else: pass
    Write_result.write( file+ ',' + B_Eye_center_width_1 + ',' + B_Eye_center_width_2 + ',' + B_Eye_center_height + ',' + B_Eye_opening_area + ',' + B_Eye_max_width_1 + ',' + B_Eye_max_width_2 + ',' + B_Eye_max_height)
    Write_result.write('\n')
